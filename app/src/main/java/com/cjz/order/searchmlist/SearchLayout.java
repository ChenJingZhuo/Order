...
public class SearchLayout extends LinearLayout{
    ...
    private void  InitView(){
        ...
        searchview =(LinearLayout)LayoutInflater.from(context).inflate(R.layout.searchlayout, null);
        //把获得的view加载到这个控件中
        addView(searchview);
        //把两个按钮从布局文件中找到
        ...
        gridviewolddata=  (SearchGridView)searchview.findViewById(R.id.gridviewolddata);
